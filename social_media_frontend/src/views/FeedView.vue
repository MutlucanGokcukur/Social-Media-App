                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            ...
                            <p class="text-xs"><strong>Defaul User 1</strong></p>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            ...
                            <p class="text-xs"><strong>Default User 2</strong></p>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            <img src="@/assets/images/default_user_3/default_user_3_300.jpeg" class="w-[40px] rounded-full">
                            
                            <p class="text-xs"><strong>Defaul User 3</strong></p>
                        </div>
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            <p class="text-xs">
                                <strong>#defaulthashtag1</strong><br>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            <p class="text-xs">
                                <strong>#defaulthashtag2</strong><br>
                                <span class="text-gray-500">180 posts</span>
                            </p>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            <p class="text-xs">
                                <strong>#defaulthashtag3</strong><br>
                                <span class="text-gray-500">180 posts</span>
                            </p>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            <p class="text-xs">
                                <strong>#defaulthashtag4</strong><br>
                                <span class="text-gray-500">180 posts</span>
                            </p>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            <p class="text-xs">
                                <strong>#defaulthashtag5</strong><br>
                                <span class="text-gray-500">180 posts</span>
                            </p>
                        </div>
